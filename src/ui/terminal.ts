...
export const terminal = (colors: UIColors, palette: Palette): VSCodeTokens => ({
  ...
  'terminalCommandDecoration.defaultBackground': colors.foreground.muted,
  'terminalCommandDecoration.successBackground': colors.success.background,
  'terminalCommandDecoration.errorBackground': colors.danger.background,
